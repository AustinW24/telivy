    ...
    return (
        <div className="App">
            <div className="container">
                <input className="" type="text" placeholder="Search by name" onChange={(e) => setSearchTerm(e.target.value)} />
                <input className="input__field" type="text" placeholder="search by tag"></input>
