                ...
                <ul className="student__list">
                    {data?.filter((val) => {
                        if (searchTerm == "" && searchTagTerm == "") {
                            return val;
                        } else if(val.firstName.toLowerCase().includes(searchTerm.toLowerCase()) || val.tags.includes(searchTagTerm.toLowerCase())){
                            return val;
                        } else if (val.tags.includes(searchTagTerm.toLowerCase())) {
                            return val;
                        }
                    }).map((student, idx) => {
                        return (
