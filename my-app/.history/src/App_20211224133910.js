            ...
            <div className="container">
                ...
                <ul className="student__list">
                    {data?.filter((val) => {
                        ...
                        if(searchTagTerm == ""){
                            return val
                        } else if (val.tags.toLowerCase().includes(searchTagTerm.toLowerCase())){
                        ...
                        return (
                            <div key={idx} className="student__row">
                                ...
                                <Tag student={student} handleTagInput={handleTagInput} tagValue={tagValue} setTagValue={setTagValue}/>
                                <hr></hr>
                            </div>
                        )
                    })}
