...
function App() {
    ...
    const [setDivId, setShowDivId] = useState("");
                            ...
                            <div key={idx} className="student__row">
                                <li className="individual__student">
                                    ...
                                    <div className="user__info">
                                        <div className="name">{student.firstName}<button onClick={(e) => handleDropDown()}><AiOutlinePlus /></button></div>
